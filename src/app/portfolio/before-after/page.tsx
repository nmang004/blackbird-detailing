...
export const metadata: Metadata = {
  title: 'Before & After - Blackbird Detailing | Transformation Gallery Virginia Beach',
  ...
  keywords: 'automotive detailing before after, car detailing transformations, Virginia Beach detailing results, paint correction before after, ceramic coating transformations',
}
